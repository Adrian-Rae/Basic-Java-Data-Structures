public class Main {
	...
	*/
	...
	tree.insert(120, 1000);
	tree.insert(50, 1000);
	tree.insert(45, 1000);
	tree.insert(122, 1000);
	
	
	//System.out.println("Structure of the constucted tree is: ");
	//tree.print();

	tree.insert(130, 1000);
	tree.insert(132, 1000);
	tree.insert(138, 1000);
	tree.insert(139, 1000);
	tree.insert(140, 1000);
	tree.insert(141, 1000);
	tree.insert(142, 1000);

	System.out.println("Structure of the new constucted tree is: ");
	tree.print();
